...
1. **Quick iterations over long projects** — ship improvements weekly, not quarterly
2. **Evaluation first** — build [[Judgment Lists]] before building models
3. **Automate what repeats** — [[Search Evaluation]] harness to catch regressions
4. **Rules before ML** — deterministic fixes often outperform learned models on sparse data
