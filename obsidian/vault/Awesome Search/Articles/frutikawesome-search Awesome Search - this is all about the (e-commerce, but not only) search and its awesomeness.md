...
published:
created: 2026-05-15
description: "Awesome Search - this is all about the (e-commerce, but not only) search and its awesomeness - frutik/awesome-search"
tags:
  - "clippings"
---
## Awesome Search

[Support Ukrainian fight for the freedom](https://savelife.in.ua/en/about-foundation-en/)
...
- Giovanni Fernandez-Kincade. [Bootstrapping Autosuggest](https://medium.com/related-works-inc/bootstrapping-autosuggest-c1ca3edaf1eb), [Building an Autosuggest Corpus, Part 1](https://medium.com/related-works-inc/building-an-autosuggest-corpus-part-1-3acd26056708), [Building an Autosuggest Corpus, Part 2](https://medium.com/related-works-inc/building-an-autosuggest-corpus-nlp-d21b0f25c31b), [Autosuggest Retrieval Data Structures & Algorithms](https://medium.com/related-works-inc/autosuggest-retrieval-data-structures-algorithms-3a902c74ffc8), [Autosuggest Ranking](https://medium.com/related-works-inc/autosuggest-ranking-d8a3242c2837)
...
- [Berlin buzzword](https://github.com/frutik/awesome-search/blob/master/berlinbuzzwords.de)
...
- [Sematext's Solr, Elasticsearch, and OpenSearch trainings](https://sematext.com/training/)
	Fall 2023
- [https://dtunkelang.medium.com/upcoming-search-classes-this-fall-58f877fe00ad](https://dtunkelang.medium.com/upcoming-search-classes-this-fall-58f877fe00ad)
...
- [List of papers](https://github.com/frutik/awesome-search/blob/master/PAPERS.md)
...
- [Reducing business risk by optimizing search](https://blog.supahands.com/2020/09/02/reducing-business-risks-by-optimizing-search/)
...
- \[Vespa\] ([https://vespa.ai/](https://vespa.ai/))
...
- [https://github.com/AiDinho/ruosh](https://github.com/AiDinho/ruosh) - A full text search library with Tantivy backend,all the goodness of whoosh api powered by Tantivy
	...
	- [Classic/Lexical search](#classic-lexical-search)
		...
		- [Embeddings](#embeddings)
			- [Types of vectors](#types-of-vectors)
				...
				- Main architectures
								- [Query/Document tokens interaction](https://github.com/frutik/awesome-search/blob/master)
...
- [Areas of application](#also-types-of-search)
	- [Enterprise search](#enterprise-search)
		...
		- [Geo-Spatial Search](https://github.com/frutik/awesome-search/blob/master)
		- [Medical and Healthcare Search](https://github.com/frutik/awesome-search/blob/master)
		- [Social Media and User-Generated Content Search](https://github.com/frutik/awesome-search/blob/master)
		- [Question Answering Systems](https://github.com/frutik/awesome-search/blob/master)
		- [Personal Information Management](https://github.com/frutik/awesome-search/blob/master)
- [Search Results](#search-results)
	- [Retrieval](#retrieval)
		...
		- [Multi stage ranking](#multi-stage-ranking)
			- [Reranking](https://github.com/frutik/awesome-search/blob/master/%C2%A3reranking)
