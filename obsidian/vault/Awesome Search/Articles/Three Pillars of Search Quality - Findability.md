...
**Source:** https://blog.searchhub.io/three-pillars-of-search-quality-in-ecommerce-part-1-findability
**Author:** [[Andreas Wagner]] (searchhub.io)
...
1. The product exists in the catalog
2. The query matches it (via keywords, [[Synonyms]], or semantic matching)
3. The result appears within the first few pages
...
1. **[[Synonyms]] expansion** — bridge vocabulary gaps
2. **Spelling correction** — catch typos before retrieval fails — see [[Spelling Correction]]
3. **Query relaxation** — fall back to partial matches before returning zero results
4. **[[Dense Vector Retrieval]]** — semantic matching covers vocabulary gaps implicitly
