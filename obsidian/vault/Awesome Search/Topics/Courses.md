---
type: topic
aliases: ["search courses", "IR courses", "search training", "learning search courses"]
tags: [topic, courses, training, learning-path]
related_concepts:
  - "[[BM25]]"
  - "[[Learning to Rank]]"
  - "[[Search Evaluation]]"
...
- **Dates:** May 8–14, 2026
- **Price:** Free
- **Covers:** [[BM25]] and lexical retrieval · [[Embeddings]] and vector databases · [[Semantic Search]] vs token matching · [[Search Evaluation]] metrics ([[NDCG]]) and their limitations · when [[Dense Vector Retrieval|embeddings]] complement vs replace lexical techniques

🔗 https://maven.com/lls/5c240b

Best as a first structured exposure before tackling the [concepts](#2-move-to-the-concepts) in depth.
...
- **Covers:** [[Agentic Search]] loops · [[RAG]] optimization · query intent analysis · [[Bi-Encoder]] vs [[Cross-Encoder]] · matrix factorization · [[Learning to Rank]] ([[LambdaMART]]) · semantic caching · [[Click Models]] · active learning · [[LTR Feature Engineering|feature engineering]] for production · [[Hybrid Search]] and [[Multimodal Embeddings|multimodal]] approaches
...
Free, practical, product-flavored intros — good for the [tools](#7-explore-the-tools) step of the learning path:
...
- **Vector-DB academies** — [[Weaviate]], [[Qdrant]], and [[Pinecone]] each publish free hands-on courses
...
- [[How to Start a Career in Search]] — where courses fit in the full learning path
- [[Books]] — companion reading list; *AI-Powered Search* and *Relevant Search* underpin the courses above
- [[Events and Conferences]] — conference talks are a free, continuous alternative
- [[Doug Turnbull]] · [[Trey Grainger]] — the instructors, and core voices in the field
