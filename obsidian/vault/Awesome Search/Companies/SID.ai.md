...
industry: agentic retrieval / AI search models
...
- **[[SID-1]]** — first model for agentic retrieval. Exposes an OpenAI-compatible API (`api.sid-1.com/v1`). Drop-in over an existing search backend (OpenSearch/Elasticsearch). Marketed as more accurate than agentic retrieval on Gemini 3 Pro, Sonnet 4.5, and GPT-5.1 while being dramatically faster and cheaper. Research page: <https://www.sid.ai/research/sid-1>
